...
public class CommonService {
	...
	public void exportAutoConfig(List<String> listSelectedProfileNames, List<Integer> listSelectedFavoriteServerIndexes,
			List<String> listSelectedRepositoryNames, File destinationFolder) throws WritingException {
		...
		for (Integer index : listSelectedFavoriteServerIndexes) {
			autoConfig.getFavoriteServers().add(favoriteServers.get(index));
		}

		for (String repositoryName : listSelectedRepositoryNames) {
			Repository repository = repositoryDAO.getMap().get(repositoryName);
			if (repository != null) {
				Repository clonedRepository = new Repository(repository.getName(), repository.getProtocol());
	...
	public void exportLogFile(String message, String filePath) throws IOException {
		...
		commonDAO.writeLog(print, filePath);
	}

	public int extractBikeys(String sourceDirectoryPath, String destinationDirectoryPath) throws IOException {

		return commonDAO.extractBikeys(sourceDirectoryPath, destinationDirectoryPath);
	}
