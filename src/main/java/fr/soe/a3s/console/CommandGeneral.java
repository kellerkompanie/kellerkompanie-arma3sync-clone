...
public class CommandGeneral {
    ...
    void checkForUpdates(boolean devMode) {
    ...
    private class RepositoryBuilder {
        ...
        RepositoryBuilder(String repositoryName,
        ...
        public void run() {
            ...
            repositoryBuildProcessor = new RepositoryBuildProcessor(
                    repositoryName);
            repositoryBuildProcessor.addObserverText(t -> {
                text = t;
                executeUpdateText(text);
            });
            repositoryBuildProcessor
                    .addObserverCountProgress(this::executeUpdateCountProgress);
            repositoryBuildProcessor.addObserverEnd(this::executeEnd);
            repositoryBuildProcessor.addObserverError(this::executeError);
    ...
    private class RepositoryChecker {
        ...
        RepositoryChecker(String repositoryName,
        ...
        public void run() {
            ...
            repositoryCheckProcessor
                    .addObserverCountProgress(this::executeUpdateCountProgress);
            repositoryCheckProcessor.addObserverEnd(this::executeEnd);
            repositoryCheckProcessor.addObserverError(this::executeError);
    ...
    private class AddonsUpdater {
        ...
        AddonsUpdater(String repositoryName) {
            this.repositoryName = repositoryName;
        }
        ...
        public void run() {
            ...
            addonsChecker.addObserverEnd(this::addonsCheckerEnd);
            addonsDownloader.addObserverEnd(this::addonsDownloaderEnd);
            addonsChecker.addObserverError(this::executeError);
            addonsDownloader.addObserverError(this::executeError);
            addonsDownloader
                    .addObserverConnectionLost(this::executeConnectionLost);
        ...
        void addObserverEndUpdate(ObserverEnd obs) {
        ...
        private class AddonsChecker {
            ...
            public void run() {
                ...
                filesCheckProcessor = new FilesCheckProcessor(repositoryName,
                        false);
                filesCheckProcessor.addObserverCount(this::executeUpdateCheck);
                filesCheckProcessor.addObserverError(this::executeError);

                filesCompletionProcessor = new FilesCompletionProcessor(
                        repositoryName);
                filesCompletionProcessor
                        .addObserverCount(this::executeUpdateCompletion);
                filesCompletionProcessor.addObserverEnd(this::executeEnd);
                filesCompletionProcessor.addObserverError(this::executeError);
        ...
        private class AddonsDownloader {
            ...
            public void run() {
                ...
                filesSynchronizationProcessor
                        .addObserverCountTotalProgress(this::executeUpdateTotalProgress);
                filesSynchronizationProcessor.addObserverEnd(this::executeEnd);
                filesSynchronizationProcessor
                        .addObserverProceedDelete(this::executeProceedDelete);
                filesSynchronizationProcessor
                        .addObserverError(this::executeError);
                filesSynchronizationProcessor
                        .addObserverConnectionLost(this::executeConnectionLost);
